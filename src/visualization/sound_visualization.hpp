...
{    
    ...
    static const short MidFrequency = 720; // 1046 Highest note reproducible by average female
    static const short MaxFrequency = 2100; // 3140 Between highest note on a flute and on a 88-key piano - Everything above will be full HighFreqColor
